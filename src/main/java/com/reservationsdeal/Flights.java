...
public class Flights {
	...
	@SuppressWarnings("unused")
	public static String executeflightsData(WebDriver driver, String from, String to) throws InterruptedException {
		...
		try {
			...
			WebElement selectCurrency = wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div/nav/div/div[3]/div/button/img")));
			...
			// Wait for and select one-way trip
			WebElement oneWayTrip = wait.until(ExpectedConditions.elementToBeClickable(
					By.xpath("/html/body/div[4]/div[2]/div/div[2]/div/form/div/div/div/div/div[1]/label[2]")));
			js.executeScript("arguments[0].click();", oneWayTrip);

			WebElement tripTypeee = driver.findElement(
					By.xpath("/html/body/div[4]/div[2]/div/div[2]/div/form/div/div/div/div/div[1]/label[2]/span"));
			String tripType = tripTypeee.getText();

			System.out.println("One way trip selected successfully");
			...
			nextmonth.click();
//			WebElement dateSelect = wait.until(ExpectedConditions
//					.visibilityOfElementLocated(By.xpath("/html/body/section[7]/div/div[2]/section/div[3]/div[14]")));
//			dateSelect.click();

			List<String> xpaths = Arrays.asList("/html/body/section[7]/div/div[2]/section/div[3]/div[22]",
					"/html/body/section[7]/div/div[2]/section/div[3]/div[24]",
					"/html/body/section[7]/div/div[2]/section/div[3]/div[26]",
					"/html/body/section[7]/div/div[2]/section/div[3]/div[28]",
					"/html/body/section[7]/div/div[2]/section/div[3]/div[30]");
...
//	      Available currency on listing page:
			...
			WebElement oneWayListing = driver
					.findElement(By.xpath("/html/body/main/div[2]/form/div/div[2]/div[1]/div/label[2]/span"));
			String tripTypeOnListing = oneWayListing.getText();
...
//   Compare Traveller's & class Home and Listing 
			...
			String availableAirlines = "No Flights";
			...
			try {
			    ...
			    if (availableAirlines.isEmpty()) {
			        ...
			        if (availableAirlines.endsWith("Show More")) {
			            availableAirlines = availableAirlines.substring(0, availableAirlines.lastIndexOf("Show More")).trim();
...
// Method to send an email using SMTP
	...
	public static void sendEmail(String to, String cc, String bcc, String subject, String body)
		...
		final String from = "sanket.mishra@snva.com";
		final String password = "Sanket29"; // Replace with your email password or use environment variables
