...
public class FourthRoute {
		   public static void executeFourthRoute(WebDriver driver, String from, String to) throws InterruptedException {
			     
		    	try{// Open the Travomint website for the second route
		        System.out.println("Open the Travomint URL for the 4th route");
		        ...
		        //driver.findElement(By.id("from")).sendKeys("IXD");
		        ...
		        //driver.findElement(By.name("to")).sendKeys("PAB");
		        ...
		        try {
		            ...
		            // Fifth Route Call
		            FifthRoute.executeFifthRoute(driver, from, to);
...
//	            result.setFromDestination(FromDestination);
	    ...
	    public static void sendEmail(String to, String cc, String bcc, String subject, String body) throws MessagingException {
	        ...
	        final String password = "";// Replace with your email password or use environment variables
