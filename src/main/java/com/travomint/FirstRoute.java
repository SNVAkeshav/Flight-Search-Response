...
public class FirstRoute {
	...
	public static void executeFirstRoute(WebDriver driver, String from, String to) throws InterruptedException {
...
//            result.setsearchTime(searchTime);
    ...
    public static void sendEmail(String to, String cc, String bcc, String subject, String body) throws MessagingException {
        ...
        final String password = "55655"; // Replace with your email password or use environment variables
