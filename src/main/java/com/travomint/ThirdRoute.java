...
public class ThirdRoute {
	   public static void executeThirdRoute(WebDriver driver, String from, String to) throws InterruptedException {
		     
	    	try{// Open the Travomint website for the second route
	        System.out.println("Open the Travomint URL for the 3rd route");
	        ...
	        //driver.findElement(By.id("from")).sendKeys("PAB");
	        ...
	        //driver.findElement(By.name("to")).sendKeys("HYD");
	        ...
	        try {
	            ...
	            // Fourth Route Call
	            FourthRoute.executeFourthRoute(driver, from, to);
